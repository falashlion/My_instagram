...
const CreatePost = ({ onNext }) => {
  const [file, setFile] = useState(null);

  const handleFileChange = (e) => {
    setFile(e.target.files[0]);
    onNext(e.target.files[0]);
  };
  ...
  return (
    <div classNameb ="page-container">
    <div className="create-post-container" onDragOver={handleDragOver} onDrop={handleDrop}>
      {file ? (
        ...
        <div className="upload-box">
          <span className="icon">
          <svg
               className="flex-shrink-0 w-10 h-10 text-black transition mx-24 duration-75 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white"
        ...
        <p className='m-2'>Drag photos and videos here</p>
